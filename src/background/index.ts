...
async function buildFillContext(
  ...
  const values: Record<string, string> = {
    ...
    currentResidenceCountry: profile.currentResidenceCountry,
    ...
    workPermitType: cp?.workPermitType ?? "",
    preferredCities: cp?.preferredCities ?? "",
    remotePreference: yesNo(cp?.remotePreference ?? ""),
  };
